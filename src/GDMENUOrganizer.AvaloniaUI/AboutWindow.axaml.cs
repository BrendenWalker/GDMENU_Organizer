...
namespace GDMENUOrganizer
{
    public partial class AboutWindow : Window, INotifyPropertyChanged
    {
        ...
        {
            var url = @"https://github.com/BrendenWalker/GDMENU_Organizer/";
            try
            {
        ...
        private async void ButtonVersion_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                using (var response = await Client.GetAsync("https://api.github.com/repos/BrendenWalker/GDMENU_Organizer/releases/latest", token))
                {
